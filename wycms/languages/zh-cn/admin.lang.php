...
/*Language Format:
Add a new file(.lang.php) with your module name at /wycms/languages/
translation save at the array:$LANG
*/

//index
$LANG['admin_site_title'] = 'WYCMS - 后台管理中心';
$LANG['expand_or_contract'] = '展开与收缩';
$LANG['wycms_title'] = 'WYCMS内容管理系统';
...
$LANG['main_safety_permissions'] = '※ 建议您将wycms目录设置为755（Linux）或只读（Windows）';
...
$LANG['main_product_team'] = 'WYCMS系统开发团队';
...
$LANG['setting_wysso'] = '启用WYSSO';
$LANG['update_wysso_cache'] = '更新缓存';
$LANG['setting_wysso_appid'] = '应用ID';
$LANG['setting_wysso_wysso_api_url'] = '接口地址';
$LANG['setting_wysso_auth_key'] = '加密密钥';
$LANG['setting_wysso_version'] = '版本号';
$LANG['must_be_number'] = '必须为数字';
$LANG['must_be_32_w'] = '为wysso中该设置的密钥';
...
$LANG['setting_wysso_type'] = '请填写接口地址，格式为：http://www.wysso.cn,结尾不包含“/”';
...
<B>互联网新闻开放协议：</B> <br>
1、互联网新闻开放协议》是百度新闻搜索制定的搜索引擎新闻源收录标准，网站可将发布的新闻内容制作成遵循此开放协议的XML格式的网页（独立于原有的新闻发布形式）供搜索引擎索引。 WYCMS可自动生成网站的Sitemaps，但是您还需要向google或者baidu提交Sitemaps的访问地址。<br>
您的网站的Sitemaps 访问地址为：<?=APP_PATH?>sitemaps.xml<br>
WYCMS可自动生成网站的<<互联网新闻开放协议>>，但是您还需要向baidu提交访问地址。<br>
...
$LANG['domain_name_format'] = '域名可为空，格式应该为http://www.wycms.cn/';
$LANG['domain_end_string'] = '格式应该为http://www.wycms.cn/，请以‘/’结束';
...
$LANG['create_to_rootdir_tips'] = '当设置了 data/configs/system.php 中的 html_root 时，将生成到该目录';
...
$LANG['site_domain_ex'] = '请填写域名，格式为：http://www.wycms.cn/';
$LANG['site_domain_ex2'] = '格式应该为http://www.wycms.cn/，请以‘/’结束';
...
$LANG['site_att_watermark_img_desc'] = '水印存放路径:skins/images/water';
...
$LANG['modelid_edit_tips'] = ' <img src="./skins/images/icon/help.gif" title="当该栏目下数据为 0 时，可更换模型">';
...
$LANG['admin_url_tips'] = '例如：admin.domain.com，绑定后，只能通过该域名登陆，配置保存在 /data/configs/system.php中，修改参数admin_url可手动取消绑定';

$LANG['geetest_open'] = '是否使用极验验证码';
$LANG['geetest_id'] = '极验ID';
$LANG['geetest_key'] = '极验KEY';

$LANG['basic_info'] = '基本信息';
$LANG['contact_us'] = '联系方式';
$LANG['other_info'] = '其他信息';
$LANG['site_info_picture'] = '站长照片';
$LANG['site_info_name'] = '站长姓名';
$LANG['site_info_area'] = '所在地区';
$LANG['site_info_license'] = '执业证号';
$LANG['site_info_company'] = '公司名称';
$LANG['site_info_duty'] = '站长职务';
$LANG['site_info_copyright'] = '版权信息';
$LANG['site_info_mobile'] = '手机号码';
$LANG['site_info_qq'] = 'Q Q号码';
$LANG['site_info_tel'] = '电话号码';
$LANG['site_info_fax'] = '传真号码';
$LANG['site_info_address'] = '联系地址';
$LANG['site_info_postcode'] = '邮政编码';
$LANG['site_info_weixin_img'] = '微信图片';
$LANG['site_info_qq_weibo'] = '腾讯微博';
$LANG['site_info_sina_weibo'] = '新浪微博';
$LANG['picture_loading_failure'] = '图片加载失败';
