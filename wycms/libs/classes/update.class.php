...
class update {
	...
	function __construct() {
		...
		$this->update_url = 'http://update.wycms.cn/index.php';
		$this->http = wy_base::load_sys_class('http','',1);
	...
	function module($type = '') {
		$string = '';
		$db = wy_base::load_model('pay_payment_model');
	...
	function check_uuid(){
		$site_db = wy_base::load_model('site_model');
