...
.attachment-list .cu{dispaly:block;float:right; background:url(skins/images/admin_img/cross.png) no-repeat 0px 100%;width:20px; height:16px; overflow:hidden;}
...
function thumb_delete(filepath,obj){
	...
	function(){
	$.get('?m=attachment&c=manage&a=pullic_delthumbs&filepath='+filepath+'&wy_ssud=<?php echo $_SESSION[wy_ssud]?>',function(data){
