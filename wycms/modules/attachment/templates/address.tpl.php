...
<form action="index.php?m=attachment&c=address&a=update&wy_ssud=<?php echo $_SESSION['wy_ssud'];?>" method="post" onsubmit="return confirm('<?php echo L('form_submit_confirm');?>')">
<table width="100%"  class="table_form">
  <tr>
    <th width="100"><?php echo L('old_attachment_address')?>：</th>
    <td class="y-bg"><input type="text" class="input-text" name="old_attachment_path" id="old_attachment_path" size="40" value="<?php echo wy_base::load_config('system', 'upload_url')?>" /> <?php echo L('old_attachment_address_msg')?></td>
  </tr>
  <tr>
