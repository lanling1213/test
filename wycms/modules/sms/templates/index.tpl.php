...
<?php } else {?>
<span class="font-fixh green">未绑定平台账户，请点击<a href="index.php?m=sms&c=sms&a=sms_setting&menuid=1539&wy_ssud=<?php echo $_GET['wy_ssud'];?>"><span class="font-fixh">平台设置</span></a>绑定。</span>
<?php }?>
</div><br>
