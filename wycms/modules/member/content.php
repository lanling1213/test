...
wy_base::load_app_func('global', 'member');
...
class content extends foreground {
	...
	public function publish() {
		...
		$priv_db = wy_base::load_model('category_priv_model'); //加载栏目权限表数据模型
	...
	public function delete(){
		...
		$check_pushed_db = wy_base::load_model('content_check_model');
	...
	function info_top() {
		...
		$catid = $_GET['catid'];
		$pos_data = wy_base::load_model('position_data_model');
	...
	function info_top_cost() {
		...
		if(isset($_POST['dosubmit'])) {
			$posids = array();
			$push_api = wy_base::load_app_class('push_api','admin');
			$pos_data = wy_base::load_model('position_data_model');
