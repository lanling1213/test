...
class client {
	...
	public function ps_getavatar_upload_html($uid) {
		...
		$upurl = base64_encode($this->ps_api_url.'/index.php?m=wysso&c=index&a=uploadavatar&auth_data='.$auth_data);
		$str = <<<EOF
				<div id="wysso_uploadavatar_flash"></div>
				<script language="javascript" type="text/javascript" src="{$this->ps_api_url}/skins/js/swfobject.js"></script>
				<script type="text/javascript">
					...
					swfobject.embedSWF("{$this->ps_api_url}/skins/images/main.swf", "wysso_uploadavatar_flash", "490", "434", "9.0.0","{$this->ps_api_url}/skins/images/expressInstall.swf", flashvars, params, attributes);
...
EOF;
	...
	*/
	...
	private function _ps_send($action, $data = null) {
 		return $this->_ps_post($this->ps_api_url."/index.php?m=wysso&c=index&a=".$action, 500000, $this->auth_data($data));
	}
