...
<input name='range' type='radio' value='' onclick="redirect('?m=poster&c=poster&a=stat&id=<?php echo $_GET['id']?>&click=<?php echo $_GET['click']?>&wy_ssud=<?php echo $_GET['wy_ssud']?>&group=<?php echo $_GET['group']?>')" <?php if(!$_GET['range']) {?>checked<?php }?>> <?php echo L('all')?>
<input name='range' type='radio' value='1' onclick="redirect('?m=poster&c=poster&a=stat&id=<?php echo $_GET['id']?>&click=<?php echo $_GET['click']?>&wy_ssud=<?php echo $_GET['wy_ssud']?>&group=<?php echo $_GET['group']?>&range='+this.value)" <?php if($_GET['range']==1) {?>checked<?php }?>> <?php echo L('today')?>
<input name='range' type='radio' value='2' onclick="redirect('?m=poster&c=poster&a=stat&id=<?php echo $_GET['id']?>&click=<?php echo $_GET['click']?>&wy_ssud=<?php echo $_GET['wy_ssud']?>&group=<?php echo $_GET['group']?>&range='+this.value)" <?php if($_GET['range']==2) {?>checked<?php }?>> <?php echo L('yesterday')?>
<input name='range' type='radio' value='7' onclick="redirect('?m=poster&c=poster&a=stat&id=<?php echo $_GET['id']?>&click=<?php echo $_GET['click']?>&wy_ssud=<?php echo $_GET['wy_ssud']?>&group=<?php echo $_GET['group']?>&range='+this.value)" <?php if($_GET['range']==7) {?>checked<?php }?>> <?php echo L('one_week')?>
<input name='range' type='radio' value='14' onclick="redirect('?m=poster&c=poster&a=stat&id=<?php echo $_GET['id']?>&click=<?php echo $_GET['click']?>&wy_ssud=<?php echo $_GET['wy_ssud']?>&group=<?php echo $_GET['group']?>&range='+this.value)" <?php if($_GET['range']==14) {?>checked<?php }?>> <?php echo L('two_week')?>
<input name='range' type='radio' value='30' onclick="redirect('?m=poster&c=poster&a=stat&id=<?php echo $_GET['id']?>&click=<?php echo $_GET['click']?>&wy_ssud=<?php echo $_GET['wy_ssud']?>&group=<?php echo $_GET['group']?>&range='+this.value)" <?php if($_GET['range']==30) {?>checked<?php }?>> <?php echo L('one_month')?> <font color="red"><?php echo L('history_select')?>：</font><select name="year" onchange="if(this.value!=''){location='?m=poster&c=poster&a=stat&id=<?php echo $_GET['id']?>&click=<?php echo $_GET['click']?>&wy_ssud=<?php echo $_GET['wy_ssud']?>&group=<?php echo $_GET['group']?>&year='+this.value;}">
