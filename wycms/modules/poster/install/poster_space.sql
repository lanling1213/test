...
CREATE TABLE IF NOT EXISTS `wy_poster_space` (
...
INSERT INTO `wy_poster_space` (`siteid`, `spaceid`, `name`, `type`, `path`, `width`, `height`, `setting`, `description`, `items`, `disabled`) VALUES
