...
<input name="jscode2" id="jscode3" value='<script language="javascript" src="<?php echo APP_PATH;?>data/vote_js/vote_<?php echo $r['subjectid']?>.js"></script>' style="width:410px">
