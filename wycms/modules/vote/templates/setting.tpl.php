...
function load_file_list(id) {
	$.getJSON('?m=admin&c=category&a=public_tpl_file_list&style='+id+'&module=vote&templates=vote_tp&name=setting&wy_ssud='+wy_ssud, function(data){$('#show_template').html(data.vote_tp_template);});
}
</script>