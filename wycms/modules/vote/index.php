...
class index {
	...
	function __construct() {
		...
		$this->vote = wy_base::load_model('vote_subject_model');//投票标题
		$this->vote_option = wy_base::load_model('vote_option_model');//投票选项
		$this->vote_data = wy_base::load_model('vote_data_model'); //投票统计的数据模型
