...
<table width="100%" class="table_form ">
    ...
    <tr>
      ...
      <td>
	  <input type='radio' name='setting[create_to_html_root]' value='1'> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
	  <input type='radio' name='setting[create_to_html_root]' value='0' checked="checked"> <?php echo L('no');?>
