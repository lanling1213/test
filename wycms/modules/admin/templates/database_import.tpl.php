...
?>   
	<tr>
	<td width="10%">
<input type="checkbox" name="filenames[]" value="<?php echo $info['filename']?>" id="sql_wycms" boxid="sql_wycms">
	</td>
...
function show_tbl(obj) {
	var pdoname = $(obj).val();
	location.href='?m=admin&c=database&a=import&pdoname='+pdoname+'&menuid='+<?php echo $_GET['menuid']?>+'&wy_ssud=<?php echo $_SESSION['wy_ssud']?>';
}
//-->
</script>