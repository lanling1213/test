...
?>
<div class="pad-10">
<?php $n=1; foreach ($menu as $key=>$v):if ($v['name']=='wysso') continue;if($n==1) {echo '<div class="map-menu lf">';}?>
<ul>
...
<li><a href="javascript:go('index.php?m=<?php echo $r['m']?>&c=<?php echo $r['c']?>&a=<?php echo $r['a']?>&wy_ssud=<?php echo $_SESSION['wy_ssud']?>&menuid=<?php echo $r['id']?><?php echo isset($r['data']) ? $r['data'] : ''?>')"><?php echo L($r['name'])?></a></li>
