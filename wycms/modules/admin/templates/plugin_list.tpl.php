...
<div class="pad_10">
<?php if(wy_base::load_config('system','plugin_debug')) { ?>
...
?>   
	...
	<td width="25%"><?php if(!$info[appid] && wy_base::load_config('system','plugin_debug')) { ?><img src="<?php echo IMG_PATH?>admin_img/plugin_debug.png" title="Developing"><?php } ?>
