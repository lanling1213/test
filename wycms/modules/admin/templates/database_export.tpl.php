...
<input type="hidden" name="tabletype" value="db" id="wycmstables">
...
?>   
    ...
    <tbody>
	<?php foreach($infos['wycmstables'] as $v){?>
	<tr>
...
function show_tbl(obj) {
	var pdoname = $(obj).val();
	location.href='?m=admin&c=database&a=export&pdoname='+pdoname+'&wy_ssud=<?php echo $_SESSION['wy_ssud']?>';
}
