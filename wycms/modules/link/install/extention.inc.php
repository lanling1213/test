...
$link_db = wy_base::load_model('link_model');
$link_db->insert(array('siteid'=>1,'typeid'=>$typeid,'linktype'=>'1','name'=>'WYCMS','url'=>'http://www.wycms.cn','logo'=>'http://www.wycms.cn/images/logo_88_31.gif','passed'=>1,'addtime'=>SYS_TIME)); 
