...
<tbody>
	...
	<tr>
		...
		<td  id="show_template"><?php if ($an_info['style']) echo '<script type="text/javascript">$.getJSON(\'?m=admin&c=category&a=public_tpl_file_list&style='.$an_info['style'].'&id='.$an_info['show_template'].'&module=announce&templates=show&name=announce&wy_ssud=\'+wy_ssud, function(data){$(\'#show_template\').html(data.show_template);});</script>'?></td>
	</tr>
	<tr>
...
function load_file_list(id) {
	$.getJSON('?m=admin&c=category&a=public_tpl_file_list&style='+id+'&module=announce&templates=show&name=announce&wy_ssud='+wy_ssud, function(data){$('#show_template').html(data.show_template);});
}
