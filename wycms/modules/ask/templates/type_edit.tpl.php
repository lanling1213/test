...
<form name="myform" id="myform" action="?m=ask&c=ask&a=edit" method="post">
<div class="pad-10">
<div class="col-tab">
...
<table width="100%" class="table_form ">
    ...
    <tr>
        ...
        <td>
        <span id="normal_add"><input type="text" name="info[typename]" id="typename" class="input-text" value="<?php echo $typename?>"></span>
...
<tr>
  <th width="200"><?php echo L('available_styles');?>：</th>
      ...
      <!--模版应用到子分类配置-->
      <tr>
        <th width="200"><?php echo '模版应用到子分类';?></th>
        <td><input type='radio' name='setting_template_child' value='1'> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
          <input type='radio' name='setting_template_child' value='0' checked> <?php echo L('no');?></td></td>
      </tr>
      <!--end 模版应用到子分类配置-->
</table>
</div>
...
<table width="100%" class="table_form ">
    <tr>
        ...
        <td>
            <input type='radio' name='setting[isclose]' value='1' <?php if($setting[isclose]) echo 'checked';?>> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
            <input type='radio' name='setting[isclose]' value='0' <?php if(!$setting[isclose]) echo 'checked';?> > <?php echo L('no');?>
        </td>
    </tr>
    <tr>
        <th><?php echo L('allow_reply');?>：</th>
        <td>
            <input type='radio' name='setting[isreply]' value='1' <?php if($setting[isreply]) echo 'checked';?>> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
            <input type='radio' name='setting[isreply]' value='0' <?php if(!$setting[isreply]) echo 'checked';?> > <?php echo L('no');?>
        </td>
    </tr>
    <tr>
        <th><?php echo L('allow_visitor_ask');?>：</th>
        <td>
            <input type='radio' name='setting[isvisitor_ask]' value='1' <?php if($setting[isvisitor_ask]) echo 'checked';?>> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
            <input type='radio' name='setting[isvisitor_ask]' value='0' <?php if(!$setting[isvisitor_ask]) echo 'checked';?> > <?php echo L('no');?>
        </td>
    </tr>
    <tr>
        <th><?php echo L('allow_visitor_reply');?>：</th>
        <td>
            <input type='radio' name='setting[isvisitor_reply]' value='1' <?php if($setting[isvisitor_reply]) echo 'checked';?>> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
            <input type='radio' name='setting[isvisitor_reply]' value='0' <?php if(!$setting[isvisitor_reply]) echo 'checked';?> > <?php echo L('no');?>
        </td>
    </tr>
    <tr>
          <th width="200"><?php echo L('expiration_interval');?></th>
          <td><input name='setting[interval_time]' type='text' size='5' maxlength='5' style='text-align:center' value='<?php echo $setting[interval_time]?>'> <?php echo L('day').L('serodata');?></td>
    </tr>
    <!--权限应用到子分类配置-->
    <tr>
        <th width="200"><?php echo '权限应用到子分类';?></th>
        <td><input type='radio' name='setting_pri_child' value='1'> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
        <input type='radio' name='setting_pri_child' value='0' checked> <?php echo L('no');?></td></td>
    </tr>
    <!--end 权限应用到子分类配置-->
</table>
</div>
