...
class guestbook extends admin {
    function __construct() {
        ...
        echo $this->M;
        $this->db = wy_base::load_model('guestbook_model');
    ...
    public function show() {
        if(isset($_POST['dosubmit'])){
             ...
             * 2012年3月29日 14:03:09
             */
            $_POST['reply_content']['reply_content'] = trim(htmlspecialchars($_POST['reply_content']['reply_content']));
            $_POST['guestbook']['replytime'] = time();
            $_POST['guestbook']['username'] =  param::get_cookie('admin_realname');
            $_POST['guestbook']['replytel'] =  param::get_cookie('admin_tel');
