...
<table cellpadding="2" cellspacing="1" class="table_form" width="100%">
	...
	<tr>
		<th width="20%"><?php echo L('guestbook_title')?>：</th>
	...
	<tr>
		<td valign="top" align="right" style="color:#777"><?php echo L('reply')?>：</th>
		<td><textarea style="width:520px;height:100px;" name="guestbook[reply_content]"><?php echo $reply_content;?></textarea></td>
	</tr>
