...
<div class="pad-lr-10">
  <table width="100%" cellspacing="0" class="search-form">
    <tbody>
      <tr>
        <td><div class="explain-col"> <?php echo L('all_linktype')?>: &nbsp;&nbsp; <a href="?m=guestbook&c=guestbook"><?php echo L('all')?></a> &nbsp;&nbsp; <a href="?m=guestbook&c=guestbook&typeid=0">免费咨询</a>&nbsp;
            <?php
	...
	foreach($infos as $info){
		?>
          <tr>
            ...
            <td align="center" ><?php echo str_cut($info['introduce'] ,'100');?></td>
            <td align="center" ><?php if($info['typeid']==0){echo "免费咨询";}else{
            $arrtype = explode('-',$info['protypid']);
            if ($arrtype[1] == '2') {
                echo '付费咨询评价';
            } elseif ($arrtype[1] == '1') {
                echo $CATEGORYS[$arrtype[0]]['catname'];
            }
            }?></td>
