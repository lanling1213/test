...
<iframe id="ifrmLogin" scrolling="no" frameborder="0" src="http://login.sdo.com/sdo/Login/LoginFrame.php?CSSURL=http://juhe.wycms.cn/skins/default/register/sdo.css&amp;returnURL=http%3A%2F%2Fjuhe.wycms.cn%2Fregister%2Findex%2Flog_get_ticket%2Fuser_back%2F<?php echo $user_back;?>%2Fwy_ssud%2F<?php echo $_GET['wy_ssud'];?>%2F&amp;appId=329&amp;areaId=-1&target=iframe">
</iframe>
<div class="links">
...
<a href="?m=video&c=video&a=complete_info&wy_ssud=<?php echo $_GET['wy_ssud'];?>"><?php echo L('complete_info_open');?> &gt;</a>
</div>
</div>
<div class="clear">
</div>
