...
class template_bak extends admin {
	...
	public function __construct() {
		...
		$this->filepath = WY_PATH.'templates'.DIRECTORY_SEPARATOR.$this->style.DIRECTORY_SEPARATOR.$this->dir.DIRECTORY_SEPARATOR.$this->filename;
		$this->fileid = $this->style.'_'.$this->dir.'_'.$this->filename;
		$this->tpl_edit = wy_base::load_config('system', 'tpl_edit');
		$this->db = wy_base::load_model('template_bak_model');
	}
