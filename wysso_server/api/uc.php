...
if(!defined('IN_WYCMS')) include WYCMS_PATH.'/wycms/base.php';

define('UC_KEY', wy_base::load_config('system', 'uc_key'));
define('UCUSE', wy_base::load_config('system', 'ucuse'));
...
if(in_array($get['action'], array('test', 'deleteuser', 'renameuser', 'gettag', 'synlogin', 'synlogout', 'updatepw', 'updatebadwords', 'updatehosts', 'updateapps', 'updateclient', 'updatecredit', 'getcreditsettings', 'updatecreditsettings'))) {
	$uc_note = new uc_note();
	header('Content-type: text/html; charset='.wy_base::load_config('system', 'charset'));
...
class uc_note {
	...
	function __construct() {
		$this->member_db = wy_base::load_model('member_model');
