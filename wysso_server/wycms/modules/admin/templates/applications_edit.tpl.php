...
<table width="100%"  class="table_form">
  ...
  <tr>
   ...
   <tr>
	...
	<option value="wycms"<?php if ($data['type']=='wycms'){echo ' selected';}?>>wycms</option>
    <option value="wycms_2008_sp4"<?php if ($data['type']=='wycms_2008_sp4'){echo ' selected';}?>>wycms_2008_sp4</option>
