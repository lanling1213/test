...
<table width="100%"  class="table_form">
  ...
  <tr>
   ...
   <tr>
	...
	<option value="wycms">wycms</option>
    <option value="wycms_2008_sp4">wycms_2008_sp4</option>
   ...
   <tr>
    ...
    <td class="y-bg"><input type="text" class="input-text" name="apifilename" id="apifilename" value="wysso.php" size="50"/></td>
  </tr>
   <tr>
...
function change_apifile(value) {
	if (value=='wycms'  && $('#apifilename').val() == '') {
		$('#apifilename').val('?m=api&c=wysso');
	}
}
</script>
