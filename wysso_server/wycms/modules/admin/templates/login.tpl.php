...
<li><label><?php echo L('checkcode')?></label><input name="code" type="text" class="login_input" maxlength="4" size="4" /><span>&nbsp;<?php echo form::checkcode('code_img', '4', '20', 95, 35)?></span></li>
