...
?>
<div class="pad-lr-10">
  <h2 class="title-1 line-x f14 fb blue lh28"><?php echo L('wysso')?></h2>
...
<table width="100%"  class="table_form">
	<tr>
		...
		<td><?php echo L('wycms_chenzhouyu')?>、<?php echo L('wycms_wangtiecheng')?></td>
	</tr>
	<tr>
		<th><?php echo L('design_team')?>：</th>
		<td><?php echo L('wycms_dongfeilong')?></td>
	</tr>
</table>
</div>
</body>
