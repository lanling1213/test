...
class form {
	...
	public static function editor($textareaid = 'content', $toolbar = 'basic', $module='', $catid='', $color = '', $allowupload = 0, $allowbrowser = 1,$alowuploadexts = '') {
		...
		if(!defined('EDITOR_INIT')) {
			$str = '<script type="text/javascript" src="skins/js/ckeditor/ckeditor.js"></script>';
		...
		if(!defined('IMAGES_INIT')) {
			$ext_str .= '<script type="text/javascript" src="skins/js/swfupload/swf2ckeditor.js"></script>';
	...
	public static function images($name, $id = '', $value = '', $moudle='', $catid='', $size = 50, $class = '', $ext = '', $alowexts = '') {
		...
		if(!defined('IMAGES_INIT')) {
			$str = '<script type="text/javascript" src="skins/js/swfupload/swf2ckeditor.js"></script>';
			define('IMAGES_INIT', 1);
		}
	...
	public static function date($name, $value = '', $isdatetime = 0) {
		...
		if(!defined('CALENDAR_INIT')) {
			...
			$str .= '<link rel="stylesheet" type="text/css" href="skins/js/calendar/calendar-blue.css"/>
			        <script type="text/javascript" src="skins/js/calendar/calendar.js"></script>';
		}
	...
	public static function checkcode($id = 'alidatecode',$code_len = 4, $font_size = 20, $width = 130, $height = 50, $font = '', $font_color = '', $background = '') {
		return "<img id='$id' onclick='this.src=this.src+\"&\"+Math.random()' src='".APP_PATH."api.php?op=alidatecode&code_len=$code_len&font_size=$font_size&width=$width&height=$height&font=".urlencode($font)."&font_color=".urlencode($font_color)."&background=".urlencode($background)."'>";
	}
	...
	public static function select_template($module, $id = '', $str = '', $pre = '') {
		...
		$tpl_name = wy_base::load_config('system','tpl_name');
		$templatedir = WY_PATH.$tpl_root.DIRECTORY_SEPARATOR.$tpl_name.DIRECTORY_SEPARATOR.$module.DIRECTORY_SEPARATOR;
